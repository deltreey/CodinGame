...
while (true) {
    ...
    var thrust = '4';
    printErr(vSpeed);
    if (vSpeed < 30 && vSpeed > -30) {
        thrust = '0';
    }
    
    result += thrust;

    print(result); // 2 integers: rotate power. rotate is the desired rotation angle (should be 0 for level 1), power is the desired thrust power (0 to 4).
}